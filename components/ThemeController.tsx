...
export default function ThemeController() {
  ...
  const colorOptions = [
    ...
    },
    {
      key: "green",
      label: "Forest Green",
      color: "bg-gradient-to-br from-green-900 to-emerald-800",
    },
    {
      key: "red",
      label: "Crimson Red",
    ...
    },
    {
      key: "orange",
      label: "Sunset Orange",
      color: "bg-gradient-to-br from-orange-900 to-amber-800",
    },
  ];
        ...
        >
          {colorOptions.map((option) => (
            <DropdownItem
              ...
              startContent={
                <div
                  className={`w-4 h-4 rounded-full ${option.color} border border-gray-300`}
                />
              }
            >
              {option.label}
